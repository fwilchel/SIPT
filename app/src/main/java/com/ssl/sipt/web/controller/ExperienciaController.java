...
@Named
@ViewScoped
public class ExperienciaController extends AbstractController {

  private static final Logger LOG = LoggerFactory.getLogger(ExperienciaController.class);

  @EJB
  private ExperienciaServiceInterface service;
  ...
  public void onRowSelect(SelectEvent event) {
    ...
    setSelected((Experiencia) event.getObject());
    setEditable(false);
    optionNavEnum = NavEnum.DETAILS;
  }
...
//      soporte.setNombre(loremIpsum.getWords(1));
   ...
   */
  public void setList(List<Experiencia> list) {
    this.list = list;
  }
